...
class StockAppGUI(ctk.CTk):
    ...
    def _setup_portfolio_tab(self):
        ...
        # Top Controls
        bar = ctk.CTkFrame(self.frame_portfolio, fg_color=COLOR_PANEL, corner_radius=RADIUS, border_width=1, border_color=COLOR_LINE)
        bar.grid(row=0, column=0, sticky="ew", pady=(0, 10))
        ...
        # Charts Area
        self.frame_charts = ctk.CTkFrame(self.frame_portfolio, fg_color=COLOR_PANEL, corner_radius=RADIUS)
