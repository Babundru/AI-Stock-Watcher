...
| `processed_urls.json` | Cache of the last 500 analysed article URLs | No — runtime state |
...
| `alerts_history.json` | The last 50 alerts shown in the Alerts panel (dashboard and desktop GUI), so it survives a restart | No — runtime state |
